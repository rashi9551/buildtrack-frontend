...
// Static data - only tasks assigned to current worker (ID: 2)
const workerTasks = [
  {
    id: 1,
    ...
    projectDescription: "Modern 15-story office building with underground parking and retail space on ground floor.",
  ...
  },
  {
    ...
    description:
      "Pour concrete for parking structure foundation. Mix ratio: 1:2:3 (cement:sand:aggregate). Ensure proper curing time.",
    projectId: 2,
    projectName: "Residential Tower A",
    projectDescription: "25-floor residential building with amenities including gym, pool, and community spaces.",
    assignedTo: "Mike Johnson",
    assignedToId: 2,
    dueDate: "2024-02-10",
    status: "Done",
  ...
  },
  {
    ...
    description:
      "Install steel framework for floors 3-5. Follow safety protocols and use proper lifting equipment. Coordinate with crane operator.",
    projectId: 1,
    projectName: "Downtown Office Complex",
    projectDescription: "Modern 15-story office building with underground parking and retail space on ground floor.",
    assignedTo: "Mike Johnson",
  ...
  },
  {
    ...
    description:
      "Apply waterproofing membrane to basement walls. Ensure complete coverage and proper sealing at joints.",
    projectId: 1,
    projectName: "Downtown Office Complex",
    projectDescription: "Modern 15-story office building with underground parking and retail space on ground floor.",
    assignedTo: "Mike Johnson",
  ...
  },
  {
    ...
    description:
      "Install reinforcement bars for foundation according to structural drawings. Check spacing and coverage requirements.",
    projectId: 2,
    projectName: "Residential Tower A",
    projectDescription: "25-floor residential building with amenities including gym, pool, and community spaces.",
    assignedTo: "Mike Johnson",
...
export function SiteWorkerDashboard({ currentUser }: SiteWorkerDashboardProps) {
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">
                  {workerTasks.filter((t) => isOverdue(t.dueDate, t.status)).length}
                </p>
              </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            My Assigned Tasks ({workerTasks.length})
          </CardTitle>
        </CardHeader>
        <CardContent>
          {/* Filters */}
            ...
            {currentTasks.map((task) => (
              <Card
                ...
                className={`hover:shadow-lg transition-all duration-200 border-l-4 ${
                  isOverdue(task.dueDate, task.status) ? "border-l-red-500 bg-red-50/30" : "border-l-orange-500"
                }`}
              >
